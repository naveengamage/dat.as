													...
													@if($user->totalComments() > $limit)
														<a href="javascript: getPage({{$page}}, '{{$user->object_id}}', 'user')" class="showmore folded" id="showmore_{{$page}}"><span class="font80perc">&#x25BC;</span> Show More</a>
