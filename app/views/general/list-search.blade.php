...
<table width="100%" cellspacing="0" cellpadding="0" class="doublecelltable" id="mainSearchTable">
	<tbody><tr>
		<td width="100%">
			...
			<div><h2>{{ $query }} posts<span>  results 1-25 from 10000</span>  <a class="rsssign" target="_blank" href="/new/rss/" title="rss"></a></h2>
					...
					<td>
						...
						<div class="torrentname">
							...
							<div class="markeredBlock torType {{$m->type()}}">
								<a href="/{{ $m->slug }}-t{{ $m->id }}.html" class="cellMainLink">{{ $m->highlight($m->title, $query) }}</a>
